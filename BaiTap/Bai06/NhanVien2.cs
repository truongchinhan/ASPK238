...
namespace BaiTap.Bai06
{
    ...
    {
        #region Cách 2: Sử dụng delegate của hệ thống
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (hslTang && TangLuong != null)
                    {
                        ...
                        TangLuong(noiDung, new EventArgs());
                    }
                }
            }
        }
        ...
        public NhanVien2(string MaSo,string HoTen, DateTime NgaySinh,DateTime NgayVaoLam, Phai GioiTinh, double HeSoLuong)
        {
            this.MaSo = MaSo;
            this.HoTen = HoTen;
